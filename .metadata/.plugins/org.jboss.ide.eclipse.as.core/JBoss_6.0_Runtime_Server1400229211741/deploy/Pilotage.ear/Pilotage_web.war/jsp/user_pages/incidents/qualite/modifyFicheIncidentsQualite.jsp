...
<head>
	...
	function retour(){
			if(document.getElementById("provenance").value == "1")
...
<body>
	<s:include value="/jsp/user_pages/commun/html_body_top.jsp">
		<s:param name="titre"><s:property value="#session.TITLE_IN_SESSION.get('ICD_QLT_M')" /></s:param>
	</s:include>
	
	<div class="contentTable">
		<s:form theme="simple" name="mainForm" action="modifyFicheIncidentsQualite" method="POST" id="mainForm">
			<s:token></s:token>
							...
							<tr>
								...
								<td align="left">
									<sj:datepicker name="dateResolution" 
													id="dateResolution" 
													displayFormat="dd/mm/yy" 
													showOn="focus" data-validation-engine="validate[custom[dateFR]]">
									</sj:datepicker>
								</td>
							</tr>
						</table>
