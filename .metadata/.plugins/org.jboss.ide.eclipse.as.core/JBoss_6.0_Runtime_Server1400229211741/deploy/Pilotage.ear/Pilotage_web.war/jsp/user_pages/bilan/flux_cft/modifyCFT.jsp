...
<body>
	<s:include value="/jsp/user_pages/commun/html_body_top.jsp">
		<s:param name="titre">
			<s:property value="#session.TITLE_IN_SESSION.get('FLX_MOD')" />
		</s:param>
	</s:include>

	<div class="contentTable">
		<s:form name="mainForm" id="mainForm" action="modifyFluxCFT"
			theme="simple">
			<s:token></s:token>
			...
			<table class="formTable">
				<tr>
					<td align="left" colspan="2">Veuillez entrer le nouveau
						libellé du flux CFT</td>
				</tr>
				<tr>
					<td>Libellé <span class="champObligatoire">*</span> :</td>
					<td><s:textfield name="libelle" id="libelle" maxlength="50"
							size="60" data-validation-engine="validate[required]"></s:textfield>
					</td>
				</tr>
