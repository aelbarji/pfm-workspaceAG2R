...
<body onload="window.focus();">
	<s:if test="%{status != 1}">
		<s:form theme="simple" id="mainForm" action="modifyPiloteVacationsAction">
			<s:hidden name="piloteID"></s:hidden>
			
			<div align="center">
				<s:property value="pilote" /><br/>
				...
				<table>
					...
					<tr>
						...
						<td><s:textfield type="text" name="textCell" id="textCell" maxlength="15"/></td>
					</tr>
				</table>
