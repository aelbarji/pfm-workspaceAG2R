...
<head>
	...
	<title><s:property value="#session.TITLE_IN_SESSION.get('CKL_COM')" /></title>
</head>
<body class="questionBorder">
	...
	<s:if test="%{status == 0}">
		<s:form id="mainForm" action="addCommentAction" theme="simple">
			...
			<table class="questionTable">
				...
				<tr>
					<td valign="top" align="center">
						<s:textarea name="commentaire" cols="30" rows="15"></s:textarea>
					</td>
				</tr>
				<tr>
					<td>
	...
	<s:elseif test="%{status==1}">
		<table  class="questionTable">
			<tr>
				<td class="info" id="info"><s:property value="%{info}"/></td>
			</tr>
			<tr>
				<td class="error" id="error"><s:property value="%{error}" /></td>
			</tr>
