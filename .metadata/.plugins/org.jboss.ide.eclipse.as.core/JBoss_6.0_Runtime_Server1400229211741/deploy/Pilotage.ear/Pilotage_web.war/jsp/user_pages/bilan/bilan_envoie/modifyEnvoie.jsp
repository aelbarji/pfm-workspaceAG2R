...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			function valider() {
				...
				if(mainForm.nom.value.replace(/^\s+/g,'').replace(/\s+$/g,'') != '<s:property value="%{nom}" />'){
					mainForm.nomChanged.value = 'true';
				}
				mainForm.submit();
	...
	<body onload="javascript:initList()">
		<s:include value="/jsp/user_pages/commun/html_body_top.jsp">
			<s:param name="titre"><s:property value="#session.TITLE_IN_SESSION.get('BL_TYPE_M')" /></s:param>
		</s:include>
		
		<div class="contentTable">
			<s:form name="mainForm" id="mainForm" action="modifyEnvoie" theme="simple" onsubmit="return false;">
				<s:token></s:token>
				<s:hidden name="selectedID"/>
				<s:hidden name="nomChanged"/>
				...
				<table class="formTable">
					...
					<tr>
						<td  align="left">Nombre d'envoi de ce type attendus par jour <span class="champObligatoire">*</span> : </td>
