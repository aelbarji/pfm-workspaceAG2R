...
<body>
	<s:include value="/jsp/user_pages/commun/html_body_top.jsp">
		<s:param name="titre">
			<s:property value="#session.TITLE_IN_SESSION.get('DEST_ADD')" />
		</s:param>
	</s:include>
	<div class="contentTable">
		<s:form id="mainForm" theme="simple" action="CreateDestinataireAction"
			method="POST">
			<s:token></s:token>
			...
			<table class="formTable" >
				...
				<tr>
					<td align="left">Prénom <span class="starObligatoire">*</span>
						:</td>
					<td align="left"><s:textfield id="prenom" name="prenom"
							maxlength="127" size="60"
							data-validation-engine="validate[required]" />
					</td>
				</tr>
				<tr>
					<td align="left">Mail <span class="starObligatoire">*</span> :
					</td>
					<td align="left"><s:textfield id="mail" name="mail"
							maxlength="127" size="60"
