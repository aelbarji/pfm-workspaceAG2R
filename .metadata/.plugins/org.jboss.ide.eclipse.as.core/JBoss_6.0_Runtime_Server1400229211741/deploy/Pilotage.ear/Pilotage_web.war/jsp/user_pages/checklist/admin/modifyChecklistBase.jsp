...
<script type="text/javascript">
			...
			function onLoad(){
				...
				checkAllFerie('listVeilleFerie', 'checkAllVeilles');
				checkAllFerie('listJourFerie', 'checkAllJours');
				checkAllFerie('listLendemainFerie', 'checkAllLendemains');
			}
			...
			function ajouter(){
				...
				var td1 = tr.insertCell(0);
				td1.setAttribute("align", "center");
				td1.innerHTML = "<input type='text' id='nomSousTache" + i + "' name='nomSousTache" + i + "' maxlength='150' style='width:90%'/>";
...
<body onload="onLoad();">
	<s:include value="/jsp/user_pages/commun/html_body_top.jsp">
		<s:param name="titre">
			<s:property value="#session.TITLE_IN_SESSION.get('CKL_MOD')" />
		</s:param>
	</s:include>
		...
		<s:form theme="simple" id="mainForm">
			...
			<table class="dataTable" rules="rows">
				...
				<tr>
					...
					<td class="titreColonne">Environnement</td>
					<td class="titreColonne">Date de d&eacute;but</td>
					<td class="titreColonne">Etat</td>
					<td class="titreColonne">Criticit&eacute;</td>
				</tr>
				<tr>
			...
			<div class="contentTableLeft">
				<table class="dataTable" rules="rows">
					<tr>
						<td class="titreColonne">Dates</td>
					</tr>
					<tr>
							...
							<table width="90%">
								...
								<tr>
									<td align="center" colspan="7">
										<hr /> Jours fériés inclus ? <s:checkbox name="f1_notFerie" />
									</td>
								</tr>
							</table></td>
					</tr>
					<tr id="frequenceDate2">
						<td align="center">
							<table width="90%">
								...
								<tr>
									<td align="center" colspan="7">
										<hr /> Jours fériés inclus ? <s:checkbox name="f2_notFerie" />
									</td>
								</tr>
							</table></td>
					</tr>
					<tr id="frequenceDate3">
						<td align="center">
							<table width="90%">
								...
								<tr>
									<td align="center" colspan="7">
										<hr /> Jours fériés inclus ? <s:checkbox name="f3_notFerie" />
									</td>
								</tr>
							</table></td>
					</tr>
							...
							<table width="90%">
								...
								<tr>
									...
									<td align="left"><s:checkbox name="checkAllLendemains"
											...
											onclick="changeLendemain(this.checked)" />Tous les lendemains
									</td>
								</tr>
							</table></td>
					</tr>
			...
			<table class="dataTable" rules="rows" id="sousTacheTable">
				...
				<tr id="textNoSousTache">
					<td colspan="5" class="emptyListText">Aucune sous tâche</td>
				</tr>
				<s:iterator value="listSousTaches" status="stat" id="sousTache">
					<tr>
						<td align="center"><input type="text" style="width: 90%"
							maxlength="150"
							name="nomSousTache<s:property value='#stat.index' />"
							id="nomSousTache<s:property value='#stat.index' />"
							value="<s:property value="#sousTache.get(0)"/>" /></td>
	
						<td>
							<table id="documentTableId<s:property value='#stat.index' />">
								<tbody>
									<tr>
										<td id="showDocumentId<s:property value='#stat.index' />"
											align="center">
											<div align="center" style="width: 100%">
												<a
													onclick="javascript:showDocumentationTree(<s:property value='#stat.index' />);"
													href="#"> <img border="0" align="middle"
													src="GCE/img/ajouter-16.png"></img> ajouter Document </a>
											</div></td>
									</tr>
									<s:set var="documents" value="documentsSousTaches[#stat.index]" />
									<c:forEach var="obj" items="${documents}" varStatus="i">
										<tr>
											<td
												id="supprDocuments<s:property value='#stat.index' /><c:out value="${i.index}" />"
												align="center"><a
												onclick="javascript:supprimerDocument(<s:property value='#stat.index' />,<c:out value="${i.index}" />);"
												href="#"><img border="0" align="top"
													src="GCE/img/supprimer-16.png" title="Supprimer"
													alt="Supprimer"></img> </a></td>
											<td><textarea
													id="documentSousTache<s:property value='#stat.index' /><c:out value="${i.index}" />"
													rows="3" style="width: 90%; display: none;"
													name="documentSousTache<s:property value='#stat.index' /><c:out value="${i.index}" />"
													readonly="true">
													<c:out value="${obj}" />
												</textarea>
												<div
													id="documentSousTacheDisplay<s:property value='#stat.index' /><c:out value="${i.index}" />"
													align="left">
													<s:property value="%{#attr.obj}" escapeHtml="true"/>
												</div>
											</td>
										</tr>
									</c:forEach>
						...
						<td align="center"><input type="text" maxlength="4" size="4"
							id="decalageSousTacheHeure<s:property value='#stat.index' />"
							name="decalageSousTacheHeure<s:property value='#stat.index' />"
							value="<s:property value="#sousTache.get(1)"/>" /> : <input
							type="text" maxlength="2" size="2"
							id="decalageSousTacheMinute<s:property value='#stat.index' />"
							name="decalageSousTacheMinute<s:property value='#stat.index' />"
							value="<s:property value="#sousTache.get(2)"/>" /></td>
						<td align="center"><textarea rows="3" style="width: 100%"
								name="consigneSousTache<s:property value='#stat.index' />"
								id="consigneSousTache<s:property value='#stat.index' />"><s:property value="#sousTache.get(3)" />
							</textarea></td>
						<td align="center"><a
							onclick="javascript:supprimerSousTache(<s:property value='#stat.index' />);"
							href="#"> <img border="0" align="top"
								src="<s:property value="#session.ENSEIGNE" />/img/supprimer-16.png"
								title="Supprimer" alt="Supprimer" /> </a></td>
					</tr>
				</s:iterator>
			</table>
			<s:include
