...
<body>
	...
	<div class="contentTable" style="width: 45%">
		<s:form id="mainForm" theme="simple" action="modifyTypeIndicateurAction" method="POST">
			<s:token></s:token>
			<s:hidden name="typeID" id="typeID" value="%{typeIndic.id}"/>
			...
			<table class="formTable">
				<tr>
					...
					<td align="left"><s:textfield name="type" value="%{typeIndic.type}" size="35" data-validation-engine="validate[required]"/></td>
				</tr>	
			</table>
