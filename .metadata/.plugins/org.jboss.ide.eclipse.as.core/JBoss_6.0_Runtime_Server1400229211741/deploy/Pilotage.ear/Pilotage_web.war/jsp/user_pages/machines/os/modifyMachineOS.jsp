...
<head>
	...
	<script type="text/javascript">
		...
		function retour(){
			submitData('showMachineOSAction.action');
		}
	</script>
</head>
...
<body>
	<s:include value="/jsp/user_pages/commun/html_body_top.jsp">
		<s:param name="titre"><s:property value="#session.TITLE_IN_SESSION.get('MAC_OS_M')" /></s:param>
	</s:include>
	
	<div class="contentTable" style="width: 40%">
		<s:form name="mainForm" id="mainForm" action="modifyMachineOSAction" theme="simple">
			<s:hidden name="selectRow"/>
			<s:hidden name="libelleChanged" value="false"/>
			<s:token></s:token>
			<table class="formTable">
				<tr>
					<td align="left" colspan="2">Veullez entrer le libellé de l'OS</td>
				</tr>
				<tr>
					<td>Libellé <span class="champObligatoire">*</span> : </td>
					<td><s:textfield id="libelle" name="libelle" maxlength="127" size="60" data-validation-engine="validate[required]"/></td>
				</tr>
				<tr>
