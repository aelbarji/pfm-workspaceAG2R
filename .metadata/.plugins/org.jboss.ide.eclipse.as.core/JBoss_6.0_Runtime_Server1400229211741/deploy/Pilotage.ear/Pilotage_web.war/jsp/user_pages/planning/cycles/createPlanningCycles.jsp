...
<body>
	<s:include value="/jsp/user_pages/commun/html_body_top.jsp">
		<s:param name="titre"><s:property value="#session.TITLE_IN_SESSION.get('PLN_CYC_C')" /></s:param>
		<s:param name="filtre" value="false"></s:param> 
	</s:include>
	
	<div class="contentTable">
		<s:form id="mainForm" theme="simple" action="createPlanningCyclesAction" method="POST">
			<s:token></s:token>
			...
			<table class="dataTable" rules="all" id="tableSemaine">
				...
				<tbody>
					...
					<s:iterator value="listSemaine" status="stat">
						<tr>
							<td align="center">
