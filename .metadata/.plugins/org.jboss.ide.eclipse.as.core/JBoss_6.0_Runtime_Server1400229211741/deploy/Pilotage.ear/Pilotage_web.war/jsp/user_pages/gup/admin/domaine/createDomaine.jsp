...
<body>
	<s:include value="/jsp/user_pages/commun/html_body_top.jsp">
		<s:param name="titre"><s:property value="#session.TITLE_IN_SESSION.get('DOM_GUP_ADD')" /></s:param>
	</s:include>
	<div class="contentTable" style="width: 65%">
		<s:form id="mainForm" theme="simple" action="createComDomaine" method="POST">
		<s:token></s:token>
