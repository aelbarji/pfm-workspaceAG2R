...
<head>
	...
	<script type="text/javascript">
		...
		function validerEtEnvoyer(){
			document.getElementById("validerEtEnvoyer").value = 1;
			valider();
		}
...
<body>
	...
	<div class="contentTable">
		<s:form theme="simple" name="mainForm" action="createDerogationAction" method="POST" id="mainForm">
		<s:token></s:token>
			...
			<s:hidden name="validerEtEnvoyer" value="0" id="validerEtEnvoyer"/>
					...
					<td align="center">
						<table width="100%">
							...
							<tr>
								...
								<td align="left">
									<input type="radio" name="rTP" id="rTP"  value="1" data-validation-engine="validate[required]"/>Oui
									<input type="radio" name="rTP" id="rTP"  value="0" data-validation-engine="validate[required]"/>Non
								</td>
							</tr>
							<tr>
								<td align="left">Présence nécessaire de l’édition <span class="starObligatoire">*</span> :</td>
								<td align="left">
									<input type="radio" name="etude" id="etude"  value="1" data-validation-engine="validate[required]"/>Oui
									<input type="radio" name="etude" id="etude"  value="0" data-validation-engine="validate[required]"/>Non
								</td>
							</tr>
							<tr>
								<td align="left">Retour arrière prévu <s:label value="*" cssClass="ligneImportante"/> :</td>
								<td align="left">
									<input type="radio" name="retourArriere" id="retourArriere"  value="1" data-validation-engine="validate[required]"/>Oui
									<input type="radio" name="retourArriere" id="retourArriere"  value="0" data-validation-engine="validate[required]"/>Non
								</td>
							</tr>
							<tr>
								<td align="left">Communication externe nécessaire <span class="starObligatoire">*</span> :</td>
								<td align="left">
									<input type="radio" name="externe" id="externe"  value="1" data-validation-engine="validate[required]"/>Oui
									<input type="radio" name="externe" id="externe"  value="0" data-validation-engine="validate[required]"/>Non
								</td>
							</tr>
							<tr>
								<td align="left">Présence du PVR de recette <span class="starObligatoire">*</span>:</td>
								<td align="left">
									<input type="radio" name="recette" id="recette"  value="1" data-validation-engine="validate[required]"/>Oui
									<input type="radio" name="recette" id="recette"  value="0" data-validation-engine="validate[required]"/>Non
								</td>
							</tr>
						</table>
					</td>
						...
						<table width="100%">
							...
							<tr>
								...
								<s:iterator value="dtcList">
									<input type="radio" name="dtcID" id="dtc" value="<s:property value="id"/>" value="typeChangement.getId()" data-validation-engine="validate[required]"/><s:property value="typeChangement"/>
								</s:iterator>
								</td>
							</tr>
							<tr>
				...
				<tr>
					<td>
						<s:include value="/jsp/user_pages/commun/html_body_div_contentTableBottom_submit.jsp">
							<s:param name="validerEtEnvoyer" value="true" ></s:param>
						</s:include>
					</td>
				</tr>
			</table>
