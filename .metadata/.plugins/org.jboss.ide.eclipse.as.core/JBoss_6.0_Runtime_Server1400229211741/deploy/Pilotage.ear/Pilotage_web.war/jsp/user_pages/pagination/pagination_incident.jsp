...
<div class="pageCenter">
	<s:if test="pageIncident > 1">
		<a href="#" onclick="changePageIncident('1');">
	...
	<s:if test="pageIncident > 1">
		<a href="#" onclick="changePageIncident('<s:property value="%{paginationIncident.pagePrecedente}"/>');">
	...
	<s:textfield name="pageInput" id="pageInput" value="%{pageIncident}" maxlength="3" size="4" cssStyle="text-align:center;" theme="simple" onchange="changePageIncident(this.value)"/>
	/<s:property value="%{paginationIncident.nrPages}" />
	<s:if test="pageIncident lt paginationIncident.nrPages">
		<a href="#" onclick="changePageIncident('<s:property value="%{paginationIncident.pageSuivante}"/>');">
	...
	<s:if test="pageIncident lt paginationIncident.nrPages">
		<a href="#" onclick="changePageIncident('<s:property value="%{paginationIncident.nrPages}" />');">
...
<div class="pageRight">     
    ...
    %>    
    <s:select list="#request.map" name="nrPerPageInput" value="%{paginationIncident.pageSize}" theme="simple" onchange="changeNrPerPageIncident(this.value)"/>
