...
<body>
	<s:include value="/jsp/user_pages/commun/html_body_top.jsp">
		<s:param name="titre"><s:property value="#session.TITLE_IN_SESSION.get('AST_MOD')" /></s:param>
	</s:include>
	<div class="contentTable">
		<s:form id="mainForm" theme="simple" action="modifyAstreinteAction" method="POST">
			...
			<table class="formTable">
				...
				<tr>
					...
					<td align="left"><s:textfield name="tel1" maxlength="20" id="tel1" size="35" data-validation-engine="validate[required,custom[phone]]"/></td>
				</tr>
				<tr>
					<td align="left">Téléphone 2 :</td>
					<td align="left"><s:textfield name="tel2" maxlength="20" id="tel2" size="35" data-validation-engine="validate[custom[phone]]"/></td>
				</tr>
				<tr>
					<td align="left">Type <span class="starObligatoire">*</span> :</td>
					<td align="left"><s:property value="%{astreinte.type.id}"/>
						<s:select list="%{aTypes}" listKey="id" listValue="type" name="type"  data-validation-engine="validate[required]"/>
					</td>
				</tr>
				<tr>
					<td colspan="2">
