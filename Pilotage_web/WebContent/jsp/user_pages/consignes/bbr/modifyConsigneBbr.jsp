...
<head>
	...
	<script type="text/javascript">
		...
		function valider(){
			...
			submitData('modifyConsigneBbrAction.action');
		}
...
<body>
	<s:include value="/jsp/user_pages/commun/html_body_top.jsp">
		<s:param name="titre"><s:property value="#session.TITLE_IN_SESSION.get('BBR_MOD')" /></s:param>
	</s:include>
				...
				<tr>
					...
					<td align="left">
						<a href="#" onclick="javascript:showDocumentationTree();">
							<textarea readonly="readonly" rows="1" style="width:90%;display=none" id="localisation" name="localisation" ><s:property value="%{localisation}" /></textarea>
						</a>
					</td>
				</tr>
				<tr>
