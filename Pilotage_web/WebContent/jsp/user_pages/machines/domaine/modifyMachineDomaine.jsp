...
<head>
	...
	<script type="text/javascript">
		...
		function valider(){
			if(document.getElementById("libelle").value.replace(/^\s+/g,'').replace(/\s+$/g,'') != '<s:property value="%{libelle}" />'){
...
<body onload="onLoad();">
	<s:include value="/jsp/user_pages/commun/html_body_top.jsp">
		<s:param name="titre"><s:property value="#session.TITLE_IN_SESSION.get('MAC_DOM_M')" /></s:param>
	</s:include>
	<div class="contentTable" style="width: 40%">
		<s:form id="mainForm" action="modifyMachineDomaineAction" theme="simple">
