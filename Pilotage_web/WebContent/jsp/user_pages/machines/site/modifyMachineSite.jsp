...
<body>
	<s:include value="/jsp/user_pages/commun/html_body_top.jsp">
		<s:param name="titre"><s:property value="#session.TITLE_IN_SESSION.get('MAC_SIT_M')" /></s:param>
	</s:include>
	
	<div class="contentTable">
		<s:form id="mainForm" theme="simple" action="modifyMachineSiteAction" method="POST">
			...
			<table class="formTable">
				<tr>
					...
					<td align="left"><s:textfield id="libelle" name="libelle" maxlength="45" size="50" data-validation-engine="validate[required]"/></td>
				</tr>
				<tr>
					<td align="left">Adresse <span class="starObligatoire">*</span> :</td>
					<td align="left"><s:textfield id="adresse1" name="adresse1" maxlength="30" size="40" data-validation-engine="validate[required]"/></td>
				</tr>
				<tr>
					<td></td>
					<td align="left"><s:textfield id="adresse2" name="adresse2" maxlength="30" size="40"/></td>
				</tr>
				<tr>
					<td align="left">Code postal <span class="starObligatoire">*</span> :</td>
					<td align="left"><s:textfield id="cp" name="cp" maxlength="5" size="10" data-validation-engine="validate[required,custom[onlyNumberSp],minSize[5]]"/></td>
				</tr>
				<tr>
