...
<body>
	<s:include value="/jsp/user_pages/commun/html_body_top.jsp">
		<s:param name="titre"><s:property value="#session.TITLE_IN_SESSION.get('MAC_SGE_M')" /></s:param>
	</s:include>
	
	<div class="contentTable">
		<s:form id="mainForm" theme="simple" action="modifyMachineInterlocuteurAction" method="POST">
			<s:hidden name="selectRow" id="selectRow" />
			<s:hidden name="libelleChanged" id="libelleChanged" value="false"/>
			<s:token></s:token>
			...
			<table class="formTable">
				...
				<tr>
					...
					<td align="left"><s:select list="%{listUsers}" listKey="id" listValue="nom + ' ' + prenom" key="%{idResponsable}" name="idResponsable" headerKey="" headerValue="" data-validation-engine="validate[required]"/></td>
				</tr>
				<tr>
					<td align="left">BAL :</td>
					<td align="left"><s:textfield name="balService" size="60"/></td>
				</tr>				
				<tr>
