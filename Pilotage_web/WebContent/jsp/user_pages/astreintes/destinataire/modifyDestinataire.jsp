...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			function valider() {
				...
				if(mainForm.mail.value != "<s:property value='mail'/>"){
					mainForm.mailChanged.value = 'true';
				}
	...
	<body>
		<s:include value="/jsp/user_pages/commun/html_body_top.jsp">
			<s:param name="titre"><s:property value="#session.TITLE_IN_SESSION.get('AST_DEST_M')" /></s:param>
		</s:include>
		
		<div class="contentTable">
			<s:form id="mainForm" action="modifyAstreinteDestinataire" theme="simple">
				<s:token></s:token>
				<s:hidden name="selectedID"/>
				<s:hidden name="mailChanged"/>
