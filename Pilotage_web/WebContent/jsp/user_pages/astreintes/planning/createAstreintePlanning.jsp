...
<body onload="onLoad();">
	<s:include value="/jsp/user_pages/commun/html_body_top.jsp">
		<s:param name="titre"><s:property value="#session.TITLE_IN_SESSION.get('AST_P_ADD')" /></s:param>
	</s:include>
	
	<div class="contentTable">
		<s:form id="mainForm" theme="simple" method="POST" action='createAstreintePlanningAction' >
			...
			<table class="formTable" border="0">
				<tr>
					...
					<td align="left"><s:select list="%{aDomaines}" listKey="id" listValue="domaine" name="domaine" emptyOption="true" data-validation-engine="validate[required]"/></td>
				</tr>
				<tr>
					<td align="left">Astreinte <span class="starObligatoire">*</span> :</td>
					<td align="left"><s:select list="%{astreintes}" id="astreinte" listKey="id" listValue="nom + ' ' + prenom" name="astreinte" emptyOption="true" data-validation-engine="validate[required]" onchange="javascript:modifyType(this.value);showAstreinteTelephone();"/></td>
					...
					<td colspan="6">
						<div class="contentTableBottom">
							...
							<div class="pageRight">
								...
								<s:submit href="#" onclick="javascript:validerEtContinuer();" value="Continuer" cssClass="boutonSubmit" ></s:submit>
							</div>
						</div>
					</td>
				</tr>
