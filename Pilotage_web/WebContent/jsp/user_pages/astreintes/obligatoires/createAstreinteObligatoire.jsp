...
<body>
	<s:include value="/jsp/user_pages/commun/html_body_top.jsp">
		<s:param name="titre"><s:property value="#session.TITLE_IN_SESSION.get('AST_O_ADD')" /></s:param>
	</s:include>
	
	<div class="contentTable">
		<s:form id="mainForm" theme="simple" action="createAstreinteObligatoireAction" method="POST">
			<s:token></s:token>
			...
			<table class="formTable">
				<tr>
					<td align="left" colspan="2">Veuillez entrer les informations de la nouvelle astreinte obligatoire</td>
				</tr>
				<tr>
					<td align="left">Domaine <span class="starObligatoire">*</span> : </td>
					<td align="left">
						<s:select list="%{aDomaines}" listKey="id" listValue="domaine" name="domaine" emptyOption="true" data-validation-engine="validate[required]"/>
					</td>
				</tr>
				<tr>
					<td align="left">Type <span class="starObligatoire">*</span> : </td>
					<td align="left">
						<s:select list="%{aTypes}" listKey="id" listValue="type" name="type" emptyOption="true" data-validation-engine="validate[required]"/>
					</td>
				</tr>
				<tr>
					<td align="left">Indic_envoi :</td>
					<td align="left"><s:checkbox name="indicEnvoi"/></td>
				</tr>
				<tr>
					<td colspan="2">
