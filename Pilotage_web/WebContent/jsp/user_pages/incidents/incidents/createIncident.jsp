...
<script type="text/javascript">
		...
		function valider(){
	     ...
	     function validerAstrInc(red){
				reinitFilterValues();
				reinitPageValues();
				changeData('last_provenance', 'redirectModifyIncident');
				document.getElementById("listT").disabled = "";
				document.getElementById("idInc").value = document.getElementById("selectedID").value;
...
<body onload="javascript:initList()">
	<s:include value="/jsp/user_pages/commun/html_body_top.jsp">
		<s:param name="titre">
			<s:property value="#session.TITLE_IN_SESSION.get('ICD_ADD')" />
		</s:param>
	</s:include>

	<div class="contentTable" style="width: 80%">
		<s:form id="mainForm" theme="simple" action="createIncident" method="POST">
			<s:token></s:token>
			...
			<table class="formTable" width="85%">
				...
				<tr>
					...
					<td align="left" colspan="3"><s:select id="listT" name="typeInciSelected" list="listTypes" listKey="id" listValue="%{type+', '+description}"
							headerKey="" headerValue="" cssStyle="width:200px;" theme="simple" data-validation-engine="validate[required]">
						</s:select>
				</tr>
				<tr>
			...
			<!-- 	<tr>
				...
				<tr>
					...
					<td align="left"><sj:datepicker name="dateDebut"
							...
							timepickerFormat="HH:mm" showOn="focus" 
				...
				<tr>
					...
					<td align="left"><input type="text" id="appli_ordonnanceur"
						name="appli_ordonnanceur" maxLength="10" data-validation-engine="validate[condRequired[job]]">
					</td>
					<td align="left">Job:</td>
					<td align="left"><input type="text" id="job" name="job" maxLength="10"
						data-validation-engine="validate[condRequired[appli_ordonnanceur]]" />
					</td>
				</tr>
				<s:if test='dateFin != "" && dateFin != null'>
					<tr id="resolu">
						<td align="left">Résolu par le pilotage <span
							class="champObligatoire">*</span> :</td>
						<td align="left" colspan="3"><input type="radio" id="resTrue"
							name="resoluPilSelected" value="1"
							data-validation-engine="validate[required]"
							<s:if test="resoluPilSelected == 1">checked="checked"</s:if> />Oui

							<input type="radio" id="resFalse" name="resoluPilSelected"
							value="0" data-validation-engine="validate[required]"
				...
				<tr>
					...
					<td><s:submit href="#" onclick="javascript:validerAstrInc(1);" value="Ajouter astreinte"></s:submit>
						</td>
				</tr>
				<tr>
