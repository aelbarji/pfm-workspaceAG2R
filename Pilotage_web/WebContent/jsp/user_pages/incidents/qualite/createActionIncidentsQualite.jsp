...
<body>
	<s:include value="/jsp/user_pages/commun/html_body_top.jsp" >
		<s:param name="titre"><s:property value="#session.TITLE_IN_SESSION.get('ICD_Q_A_C')" /></s:param>
	</s:include>
	
	<div class="contentTable">
		<s:form theme="simple" name="mainForm" action="createActionIncidentsQualite" method="POST" id="mainForm">
					...
					<td align="center">
						<table width="100%">
							...
							<tr>
								...
								<td align="left"><s:textarea name="action" id="action" cols="60" rows="5" value=""/></td>
							</tr>
						</table>
					</td>
				</tr>
