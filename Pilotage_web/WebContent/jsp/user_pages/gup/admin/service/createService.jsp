...
<head>
	...
	function retour() {
		submitData("showComService.action");
	}
...
<body>
	<s:include value="/jsp/user_pages/commun/html_body_top.jsp">
		<s:param name="titre"><s:property value="#session.TITLE_IN_SESSION.get('SER_COM_ADD')" /></s:param>
	</s:include>
	<div class="contentTable" style="width: 50%">
		<s:form id="mainForm" theme="simple" action="createComService" method="POST">
		<s:token></s:token>
