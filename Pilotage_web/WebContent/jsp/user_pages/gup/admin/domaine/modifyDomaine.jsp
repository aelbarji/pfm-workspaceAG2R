...
<head>
	...
	function retour() {
		submitData("showComDomaine.action");
	}
...
<body>
	<s:include value="/jsp/user_pages/commun/html_body_top.jsp">
		<s:param name="titre"><s:property value="#session.TITLE_IN_SESSION.get('DOM_COM_MOD')" /></s:param>
	</s:include>
	<div class="contentTable" style="width: 65%">
		<s:form id="mainForm" theme="simple" action="modifyComDomaine" method="POST">
		<s:token></s:token>
		<s:hidden name="selectedID" id="selectedID"/>
		<table class="formTable" width="65%">
		<tr height="30"></tr>
		<tr>
			<td align="left">Nom <span class="starObligatoire">*</span> : </td>
			<td align="left"><s:textfield id="nom" name="nom" maxlength="40" size="30" data-validation-engine="validate[required]"/></td>
		</tr>
		<tr>
					<td colspan="2">
