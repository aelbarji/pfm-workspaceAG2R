...
public class AnnulerFeedbackAction extends AbstractAction {
	...
	protected String executeMetier() {
		try {
			...
			FeedbackDatabaseService.setEtat(selectRow, PilotageConstants.FEEDBACK_ETAT_ANNULE);
			info = getText("feedback.annulation.valide");
			
			return OK;
		}
		catch (Exception e) {
			error = getText("error.message.generique") + " : " + e.getMessage();
			erreurLogger.error("Annulation d'un feedback - ", e);
			return ERROR;
		}
