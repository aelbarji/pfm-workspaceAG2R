...
<body>
	...
	<div class="contentTable">
		<s:form id="mainForm" theme="simple" action="createEnvironnementAction" method="POST">
			<s:token></s:token>
			<s:hidden name="sens"/>
			<s:hidden name="sort"/>
			<s:hidden name="page"/>
			...
			<table class="formTable">
				<tr>
					<td align="left" colspan="2">Veuillez entrer les informations du nouvel environnement</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="left">
						<s:select list="%{environnement_Types}" listKey="id" listValue="type" name="type" emptyOption="true" onkeydown="submitOnKeyPress(event);" data-validation-engine="validate[required]"/>
					</td>
				</tr>
				<tr>
					<td colspan="2">
