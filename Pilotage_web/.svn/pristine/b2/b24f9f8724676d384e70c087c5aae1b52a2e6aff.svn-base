...
<body onload="onLoad();">
	<s:include value="/jsp/user_pages/commun/html_body_top.jsp">
		<s:param name="titre"><s:property value="#session.TITLE_IN_SESSION.get('MTG_GRM_A')" /></s:param>
	</s:include>

	<div class="contentTable" style="width: 45%">
		<s:form id="mainForm" theme="simple" action="createGroupeMeteoAction" method="POST">
			<s:token></s:token>
			...
			<table class="formTable">
				<tr>
					...
					<td align="left"><s:textfield name="nom_groupeMeteo" value="%{nom_groupeMeteo}" size="35" data-validation-engine="validate[required]"/></td>
				</tr>	
				<tr>
