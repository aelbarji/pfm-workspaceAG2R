...
<body>
	...
	<div class="contentTable" style="width: 80%">
		<s:form id="mainForm" theme="simple" action="CreateDebordementNocAction" method="POST">
		<s:token></s:token>
				...
				<div class="contentTableBottom">
					<span class="champObligatoire">* Champs Obligatoires</span>
						<div class="pageRight">
							...
							<s:submit href="#" onclick="javascript:valider();" value="Envoyer" cssClass="boutonSubmit" ></s:submit>
						</div>
				</div>
			</td>
		</tr>
