...
public class AttenteFeedbackAction extends AbstractAction {
	...
	protected String executeMetier() {
		try {
			...
			FeedbackDatabaseService.setEtat(selectRow, PilotageConstants.FEEDBACK_ETAT_EN_ATTENTE);
			info = getText("feedback.modification.etat.valide");
			
			return OK;
		}
		catch (Exception e) {
			error = getText("error.message.generique") + " : " + e.getMessage();
			erreurLogger.error("Mise en attente d'un feedback - ", e);
			return ERROR;
		} 
